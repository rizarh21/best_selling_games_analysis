...
#top 10 games with the highest prices
highest_price = data.sort_values(by="price", ascending=False).head(10)

plt.figure(figsize=(10, 6))
plt.barh(highest_price['game_name'], highest_price['price'], color='skyblue')
plt.xlabel('Price')
plt.title('Top 10 Games with The Highest Price')
plt.gca().invert_yaxis()
plt.tight_layout()
plt.show()
